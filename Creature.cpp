...
// Inside the Creature class definition in Creature.cpp
...
{
    return (name_ == rhs.name_) && (category_ == rhs.category_) && (level_ == rhs.level_) && (tame_ == rhs.tame_);
}
...
/**
  ...
  @return     : Returns true if the right hand side creature is NOT "equal" (!=), false         
                ...
                NOTE: By this definition, one or more of the aforementioned subsets of the creature's attributes only must be different for two creatures to be deemed "NOT equal".
*/
bool Creature::operator!=(const Creature& rhs) const
{
        return name_!= rhs.name_ || category_!= rhs.category_|| level_!= rhs.level_ || tame_!= rhs.tame_;
